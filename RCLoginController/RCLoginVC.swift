...
public class RCLoginVC: UIViewController {
    ...
    public func presentLoginInNavigation(authyAPIKey authyAPIKey : String, loginColor: UIColor = UIColor.lightGrayColor(), existingUserCheck: ((RCUser, (Bool, RCUser) -> Void) -> Void)? = nil) {
