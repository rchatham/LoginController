...
public protocol Loggable { //@objc if you want optional email
...
public class RCLoginController {
    ...
    func didEnter(phoneNumber phoneNumber: String, withCountryCode countrycode: Int, completion: (Void -> ())? = nil ) {
    ...
    func didEnter(phoneNumber phoneNumber: String, withCountryCode countrycode: Int, andEmail email: String, completion: (Void -> ())? = nil ) {
        login.phoneNumber = phoneNumber
        login.countryCode = countrycode
        login.email = email
    ...
    func shouldLogin<T : Loggable>() -> T? {
        ...
        loggable = loadFromSaved(loggable)
    ...
    func loadFromSaved<T : Loggable>(type: T) -> T {
